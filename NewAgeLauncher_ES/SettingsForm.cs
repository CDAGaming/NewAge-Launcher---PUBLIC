...
namespace NewAgeLauncher
{
    public partial class SettingsForm : Form
    {
        ...
        private void SettingsForm_Load(object sender, EventArgs e)
        {
            ...
            Launguage_ComboBox.SelectedText = Settings_ES.Default.LaunguageSet;
        }
        ...
        private void save_button_Click(object sender, EventArgs e)
        {
            ...
            {
                Settings_ES.Default.LaunguageSet = Launguage_ComboBox.SelectedText;
                System.Diagnostics.Process.Start(Application.StartupPath + "/bin/LaunguageChanger.exe");
                WindowState = FormWindowState.Minimized;
